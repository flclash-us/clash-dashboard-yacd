...
wget -O lcp.sh https://raw.githubusercontent.com/flclash-us/vps-guide-2gfg22/main/lcp.sh
chmod +x lcp.sh
bash lcp.sh install
lcp start
...
wget -O tcp_optimize.sh https://raw.githubusercontent.com/flclash-us/vps-guide-2gfg22/main/tcp_optimize.sh
